...
componentDidMount(){
  ...
  if (time >= 14 && time < 17) {this.setState({image: "https://motionarray.imgix.net/preview-32497VWLgUILjcV_0005.jpg"})}
  if (time >= 17 && time < 19) {this.setState({image: "https://www.gannett-cdn.com/media/2017/06/22/Phoenix/Phoenix/636336921421960839-RS2-7663.jpg"})}
  if (time >= 19 && time < 22) {this.setState({image: "https://upload.wikimedia.org/wikipedia/commons/5/58/Sunset_2007-1.jpg"})}
